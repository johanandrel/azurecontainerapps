...
{
    app.Logger.LogInformation("Somebody visiting home");
...
app.MapGet("/startup", async context =>
{
    app.Logger.LogInformation("Startup ready!");
...
record Album(int Id, string Title, string Artist, double Price, string Image_url)
{
     public static List<Album> GetAll(){
         var albums = new List<Album>(){
            new Album(1, "You, Me and a Lars", "Daprize", 10.99, "https://aka.ms/albums-daprlogo"),
